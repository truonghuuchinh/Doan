...
var FullCalendar = (function (exports) {
    ...
    ***************************************************************************** */
    ...
    function getMonthNumeric(str, today) {
        str = str.toString();
        ...
        if (str.toString() === today) {
            return mnths[date[1]] + ' - Hôm nay';
        }
        return mnths[date[1]];
    }

    function rebuildTitle(str) {
        let mnths = {
            Jan: "Tháng 1",
            Feb: "Tháng 2",
            Mar: "Tháng 3",
        ...
        let date = str.toString().split(" ");
        return mnths[date[1]] + ', ' + date[3];
    }

    function rebuildHeaderCell(date) {
        let dys = {
            Mon: "Thứ 2",
            Tue: "Thứ 3",
            Wed: "Thứ 4",
    ...
    */
    ...
    StandardTheme.prototype.iconClasses = {
        close: 'fc-icon-x',
        prev: '../assets/img/ic_select_left_24px.svg',
        // prev: 'fc-icon-chevron-left',
        // next: 'fc-icon-chevron-right',
        next: '../assets/img/ic_select_right_24px.svg',
    ...
    */
    ...
    function buildTitle(dateProfile, viewOptions, dateEnv) {
        ...
        return rebuildTitle(dateProfile.currentRange.start);
    ...
    var ToolbarSection = /** @class */ (function (_super) {
        ...
        ToolbarSection.prototype.renderWidgetGroup = function (widgetGroup) {
            ...
            for (var _i = 0, widgetGroup_1 = widgetGroup; _i < widgetGroup_1.length; _i++) {
                ...
                if (buttonName === 'title') {
                ...
                else if (buttonName === 'sub-title') {
                    isOnlyButtons = false;
                    children.push(createElement("div", { className: "sub-title" }, props.title))
                }
                else {
                    ...
                    children.push(createElement("button", __assign({ disabled: isDisabled, className: buttonClasses.join(' '), onClick: buttonClick, type: "button" }, ariaAttrs), buttonText || (buttonIcon ? createElement("img", { src: buttonIcon }) : '')));
                }
            }
            ...
            return (createElement(RenderHook, { hookProps: hookProps, classNames: options.dayHeaderClassNames, content: options.dayHeaderContent, defaultContent: renderInner, didMount: options.dayHeaderDidMount, willUnmount: options.dayHeaderWillUnmount }, function (rootElRef, customClassNames, innerElRef, innerContent) {
                return (createElement("th", __assign({ ref: rootElRef, className: classNames.concat(customClassNames).join(' '), colSpan: props.colSpan }, props.extraDataAttrs),
                    createElement("div", { className: "fc-scrollgrid-sync-inner" },
                        ...
                        }, rebuildHeaderCell(innerContent)))));
            }));
        };
        return TableDowCell;
    }(BaseComponent));
    ...
    */
    ...
    function renderInnerContent(innerProps) {
        let isStart = innerProps.isStart;
        let isEnd = innerProps.isEnd;
        return (createElement("div", { className: "fc-event-main-frame" },
            innerProps.timeText && (createElement("div", { className: "fc-event-time" }, innerProps.timeText)),
            createElement("div", { className: "fc-event-title-container" },
                createElement("div", { className: "fc-event-title fc-sticky" }, ((isStart && !isEnd) || (isStart && isEnd)) ? innerProps.event.title : "" || createElement(Fragment, null, "\u00A0")))));
    }
        ...
        TableCellTop.prototype.render = function () {
            ...
            return (createElement(DayCellContent, { date: props.date, dateProfile: props.dateProfile, todayRange: props.todayRange, showDayNumber: props.showDayNumber, extraHookProps: props.extraHookProps, defaultContent: renderTopInner }, function (innerElRef, innerContent) {
                return ((innerContent || props.forceDayTop) && (createElement("div", { className: "fc-daygrid-day-top", ref: innerElRef },
                    createElement("a", __assign({ className: "fc-daygrid-day-number" }, navLinkAttrs), `${innerContent}/${getMonthNumeric(props.date, props.todayRange.start)}` || createElement(Fragment, null, "\u00A0")))));
            }));
        };
        return TableCellTop;
    }(BaseComponent));
            ...
            return (createElement(DayCellRoot, { date: date, dateProfile: dateProfile, todayRange: props.todayRange, showDayNumber: props.showDayNumber, extraHookProps: props.extraHookProps, elRef: this.handleRootEl }, function (dayElRef, dayClassNames, rootDataAttrs, isDisabled) {
                return (createElement("td", __assign({ ref: dayElRef, className: ['fc-daygrid-day'].concat(dayClassNames, props.extraClassNames || []).join(' ') }, rootDataAttrs, props.extraDataAttrs),
                    createElement("div", { className: "fc-daygrid-day-frame fc-scrollgrid-sync-inner", ref: props.innerElRef /* different from hook system! RENAME */ },
                        ...
                        createElement("div", { className: "fc-daygrid-day-events", ref: props.fgContentElRef, style: { paddingBottom: props.fgPaddingBottom/*, position: "initial" */} },
                            props.fgContent,
            ...
            if (framePositions) {
                for (var _i = 0, segs_1 = segs; _i < segs_1.length; _i++) {
                    ...
                    if (isAbsolute) {
                        ...
                        if (seg.eventRange.range.end > todayRange.start) {
                            bottom = 0;
                        }
                    }
                    else {
                    ...
                    */
                    ...
                    nodes.push(createElement("div", {
                        className: 'fc-daygrid-event-harness' + (isAbsolute ? ' fc-daygrid-event-harness-abs ' : '') + (bottom === 0 ? 'bot-pos' : ''), key: instanceId,
