    ...
    */
    ...
    //             };
    //             var f =
    //             this.headers.index(this.active[0]) > this.headers.index(a[0]);
    //             this.active = b ? c([]) : a;
    ...
    */
    ...
    a.widget("ui.button", {
        ...
        //         e.push(
        //         "ui-button-text-icon" +
        //             (f ? "s" : d.primary ? "-primary" : "-secondary")
        //         );
        //     d.primary &&
        //         b.prepend(
        //         "<i style='color:#D30059' class='" + d.primary + "'></i>"
        //         );
        //     d.secondary &&
        //         b.append(
    ...
    */
    ...
    //     return (
    //         (b.title &&
    //         b.title.replace(/\s/g, "_").replace(/[^\w\u00c0-\uFFFF-]/g, "")) ||
    ...
    //                 a.element.find(
    //                 a._sanitizeSelector(a.anchors[c.selected].hash)
    //                 )[0]
    //             )
    //             );
    //         });
    ...
    //         d(j)[
    //         d.inArray(b, c.disabled) != -1 && !d(j).hasClass("ui-tabs-selected")
    //             ? "addClass"
    //             : "removeClass"
    //         ]("ui-state-disabled");
    ...
    //     j.length ||
    //         (j = d(h.panelTemplate).attr("id", b).data("destroy.tabs", true));
    //     j.addClass(
    ...
    */
    ...
    //         a &&
    //         (a.type == "hidden" || a.nodeType != 1 || d.expr.filters.hidden(a));
    ...
    //             if (
    //                 b.substr(s, p[v].length).toLowerCase() == p[v].toLowerCase()
    //             ) {
    //                 s += p[v].length;
    //                 return v + 1;
    //             }
    ...
    //         g = g.getDate();
    //         for (
    //             var u = /([+-]?[0-9]+)\s*(d|D|w|W|m|M|y|Y)?/g, k = u.exec(h);
    //             k;
    ...
    //                 ? c
    //                 : e(b)
    //             : new Date(b.getTime())) && b.toString() == "Invalid Date"
    //             ? c
    //             : b)
    //     ) {
    //         b.setHours(0);
    ...
    //             t +
    //             '">' +
    //             (/all|left/.test(t) && D == 0 ? (c ? f : n) : "") +
    //             (/all|right/.test(t) && D == 0 ? (c ? n : f) : "") +
    //             this._generateMonthYearHeader(a, g, m, k, o, D > 0 || E > 0, z, w) +
    ...
    //                 g == a.selectedMonth &&
    //                 a._keyEvent) ||
    //                 (L.getTime() == q.getTime() && L.getTime() == N.getTime())
    //                 ? " " + this._dayOverClass
    //                 : "") +
    //                 (J
